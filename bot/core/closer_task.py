...
def get_closer_task_time(api: SkillBoxAPI, course_id: str) -> Optional[datetime]:
    homeworks = api.get_all_homeworks(course_id, status=HomeworkStatus.WAIT, order=HomeworkOrder.NEW)
    if homeworks:
